...
public class VertiGoneHelper extends BluetoothHelper {
	...
	final static String DEVICENAME = "VGONE";
	final static private UUID mVertiGoneServiceUuid = BleDefinedUUIDs.Service.VGONE;
	...
	public boolean initialize() {
        ...
        Status.CurrentVertiGoneStatus = Status.VertiGoneStatus.Waiting;
        Status.printBLEStatus();
		debug("Initialized");
